    ...
    public partial class Form17 : Form
    {
        ...
        private void Form17_Load(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                string sql = "SELECT id AS '№', Class_type AS 'Классификация', Name_obj AS 'Наименование', Unit AS 'Единица измерения', Price AS 'Цена' FROM service";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                string selectQuery = "SELECT COUNT(*) FROM service WHERE id = @id";
                string insertQuery = "INSERT INTO service (Class_type, Name_obj, Unit, Price) VALUES (@class_type, @name_obj, @unit, @price)";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    string query = "UPDATE service SET Class_type = @ClassType, Name_obj = @NameObj, Unit = @Unit, Price = @Price WHERE id = @Id";
